export const _ROUTES = {
    ...
    CART_PAYMENT_DECLINE: '/payments/decline',

    SUBSCRIBE_PAYMENT_SUCCESS: '/payments/subscribe-success',
    SUBSCRIBE_PAYMENT_DECLINE: '/payments/subscribe-decline',

    PAYMENT_REFUND_CANCEL: '/payments/refund-cancel',

    CUSTOMER_SUBSCRIPTION: '/customers/subscriptions',
}

export const _RECURRING_PAYMENT_METHODS = {
    "Alipay": "alipay",
    "bKash": "bkash",
    "Dana": "dana",
    "Easypaisa": "easypaisa",
...
export const _SUBSCRIPTION_MONTHS = {
    "1 month": "1",
    "2 months": "2",
    "3 months": "3",
    "4 months": "4",
...
export const _COUNTRIES = {
    countries: [
        ...
        {
            "country": "Bermuda",
            "states": ["Devonshire", "Hamilton", "Paget", "Pembroke", "Saint George", "Saint George's", "Sandys", "Smith's", "Southampton", "Warwick"]
        },
        {
            "country": "Bhutan",
